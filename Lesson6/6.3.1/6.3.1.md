...
![alt text](https://intermediatev3.codingcredentials.com/Lesson6/6.3.1/images/6.3.1.gif?raw=true "complete")
...
To do this place a ``||FUNCTIONS:call buildHouse 1||`` block and change the parameter value to 4 to build a house 4 levels/storys/floors high.
